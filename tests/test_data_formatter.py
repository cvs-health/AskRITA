...
class TestDataFormatter:
    ...
    def test_initialization(self, mock_config, mock_llm_manager):
        ...
        with patch(
            "askrita.sqlagent.formatters.DataFormatter.LLMManager", create=True
        ) as mock_llm_class:
...
class TestFormatDataForVisualization:
    ...
    def test_format_data_scatter_plot_two_columns(
        self, mock_data_formatter, visualization_test_data
    ):
    ...
    def test_format_data_scatter_plot_three_columns(
        self, mock_data_formatter, visualization_test_data
    ):
    ...
    def test_format_data_bar_chart_two_columns(
        self, mock_data_formatter, visualization_test_data
    ):
        ...
        mock_llm.invoke.return_value = type(
            "MockResponse", (), {"universal_format": mock_chart_data}
        )()
        mock_data_formatter.llm_manager.llm.with_structured_output.return_value = (
            mock_llm
        )
    ...
    def test_format_data_bar_chart_three_columns(
        self, mock_data_formatter, visualization_test_data
    ):
        ...
        mock_chart_data = UniversalChartData(
            ...
            datasets=[
                ...
                ChartDataset(
                    label="Q2",
                    data=[
                        DataPoint(label=_PRODUCT_A, value=120.0),
                        DataPoint(label=_PRODUCT_B, value=180.0),
                    ],
                ),
            ],
    ...
    def test_format_data_line_chart_two_columns(
        self, mock_data_formatter, visualization_test_data
    ):
    ...
    def test_format_data_line_chart_three_columns(
        self, mock_data_formatter, visualization_test_data
    ):
    ...
    def test_format_data_horizontal_bar(
        self, mock_data_formatter, visualization_test_data
    ):
    ...
    def test_format_data_other_visualization_types(self, mock_data_formatter):
        ...
        mock_response.legacy_format = {
            "data": [
                {"name": _CATEGORY_A, "value": 30},
                {"name": _CATEGORY_B, "value": 70},
            ]
        }
        ...
        mock_response.universal_format.model_dump = Mock(
            return_value={
                "type": "pie",
                "datasets": [
                    {
                        "label": "Data",
                        "data": [
                            {"value": 30, "label": _CATEGORY_A},
                            {"value": 70, "label": _CATEGORY_B},
                        ],
                    }
                ],
            }
        ...
        mock_data_formatter.llm_manager.invoke_with_structured_output.return_value = (
            mock_response
        )
...
class TestDataFormatterErrorHandling:
    ...
    def test_format_data_scatter_unexpected_columns(self, mock_data_formatter):
        ...
        mock_data_formatter.llm_manager.invoke_with_structured_output_direct.side_effect = Exception(
            _STRUCTURED_OUTPUT_FAILED
        )
    ...
    def test_format_data_scatter_exception_fallback(self, mock_data_formatter):
        ...
        mock_data_formatter.llm_manager.invoke.return_value = (
            '{"series": [{"data": [{"x": 1, "y": 100}]}]}'
        )
...
class TestSpecificDataFormats:
    ...
    def test_line_chart_label_detection(self, mock_data_formatter):
        ...
        mock_response.universal_format.datasets = [
            Mock(
                label=_LABEL_A,
                data=[Mock(x="2023-01", y=100), Mock(x="2023-02", y=120)],
            ),
            Mock(
                label=_LABEL_B,
                data=[Mock(x="2023-01", y=150), Mock(x="2023-02", y=180)],
            ),
        ]
        mock_response.universal_format.model_dump = Mock(
            return_value={
    ...
    def test_scatter_plot_label_detection(self, mock_data_formatter):
        ...
        results = [("Group A", 10, 100), ("Group A", 20, 150), ("Group B", 15, 120)]
    ...
    def test_bar_chart_with_string_conversion(self, mock_data_formatter):
        ...
        results = [(123, 100.5), (456, 200.3), (789, 150.7)]  # Numeric labels
        ...
        mock_data_formatter.llm_manager.invoke_with_structured_output_direct.side_effect = (
            None
        )
        mock_response = Mock()
        mock_response.legacy_format = {
        ...
        mock_response.universal_format = Mock()
        mock_response.universal_format.dict.return_value = {
            "type": "bar",
            "datasets": [],
        }
        mock_data_formatter.llm_manager.invoke_with_structured_output_direct.return_value = (
            mock_response
        )
    ...
    def test_line_chart_date_string_handling(self, mock_data_formatter):
        ...
        mock_response.universal_format.datasets = [
            Mock(
                label=_REGION_A,
                data=[Mock(x="2023-01-01", y=1000), Mock(x="2023-02-01", y=1200)],
            ),
            Mock(
                label=_REGION_B,
                data=[Mock(x="2023-01-01", y=800), Mock(x="2023-02-01", y=900)],
            ),
        ]
        mock_response.universal_format.model_dump = Mock(
            return_value={
