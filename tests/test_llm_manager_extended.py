...
class TestLLMManagerInitialization:
    ...
    @patch.dict(os.environ, {'OPENAI_API_KEY': 'test-key', 'AZURE_OPENAI_API_KEY': 'test-key'})
    def test_initialization_azure(self, mock_config):
        ...
        with patch('askrita.utils.LLMManager.AzureChatOpenAI', create=True) as mock_azure:
