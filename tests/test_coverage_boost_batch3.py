...
class TestChartGeneratorMissingPaths:
    ...
    def test_generate_chart_bytes_exception_returns_none(self):
        ...
        with patch(
            "askrita.sqlagent.exporters.chart_generator._normalize_chart_data",
    ...
    def test_pptx_resolve_series_secondary_match(self):
        ...
        from askrita.sqlagent.exporters.chart_generator import (
            _pptx_resolve_series_secondary,
        )
    ...
    def test_add_native_pptx_chart_no_categories_returns_false(self):
        ...
        with patch(
            "askrita.sqlagent.exporters.chart_generator._pptx_extract_labels_values",
            return_value=([], [], "bar"),
        ):
...
class TestExcelExporterMissingPaths:
    ...
    def test_generate_excel_export_xlsxwriter_unavailable(self):
        ...
        with patch(
            "askrita.sqlagent.exporters.excel_exporter.XLSXWRITER_AVAILABLE", False
        ):
    ...
    def test_generate_excel_export_exception_raises_export_error(self):
        ...
        with (
            patch.object(excel_mod, "XLSXWRITER_AVAILABLE", True),
...
class TestCoreExporterMissingPaths:
    ...
    @pytest.mark.skipif(
        not getattr(
            __import__("askrita.sqlagent.exporters.core", fromlist=["PDF_AVAILABLE"]),
            "PDF_AVAILABLE",
            False,
        ),
    ...
    def test_pdf_append_chart_no_chart_data(self):
        ...
        with patch(
            "askrita.sqlagent.exporters.core.get_chart_data_for_export",
